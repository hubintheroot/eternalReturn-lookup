...
import type { CharacterWithSkins } from '@/shared/types';
import * as Styled from './CharacterCard.styled';

interface CharacterCardProps {
  data: CharacterWithSkins;
  maxLength: number;
...
export default function CharacterCard({
  ...
  const handleError = (e: SyntheticEvent<HTMLImageElement>) => {
    ...
    target.src = `${process.env.PUBLIC_URL}/icons8-64.png`;
    target.classList.add('prepare-image');
    setDisabled(true);
    if (maxLength === cnt.current) setCharListLoaded(false);
  };
