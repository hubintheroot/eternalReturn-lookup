...
import type { PatchNoteSummary } from '@/shared/types';

export default function PatchNotesView(): ReactElement {
  const [patchNotes, setPatchNotes] = useState<PatchNoteSummary[]>([]);
  ...
  return (
    <Styled.Section>
      <Styled.TitleContainer>
        ...
        <Styled.Desc>
          패치노트 내용 중 신규 실험체, 실험체 및 아이템 변경점, 신규 시스템를
          제공합니다.
        </Styled.Desc>
      </Styled.TitleContainer>
      {loading ? (
