...
`;
export const CharacterIconItem = styled.button<SelectedProps>`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`;
export const AccordionChevron = styled.span<IsOpenProps>`
  margin-left: auto;
...
export const AccordionContent = styled.div`
  ...
  background-color: #ffffff;
`;
export const VariantBadge = styled.span<VariantProps>`
  display: inline-block;
...
export const WeaponTypePill = styled.span`
  ...
  margin-top: 0.25rem;
`;
export const CharacterDetailPanel = styled.div<DetailPanelProps>`
  position: absolute;
